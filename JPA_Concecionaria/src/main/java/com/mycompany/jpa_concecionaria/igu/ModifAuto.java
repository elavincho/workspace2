...
public class ModifAuto extends javax.swing.JFrame {
    ...
    //Inicializamos la controladora como null
    Controladora control = null;

    Automovil auto = new Automovil();

    public ModifAuto(int idAuto) {
        //Instanciamos a la controladora en el contructor para asegurarnos de
        // que inicialice la controladora al iniciar los componentes
        control = new Controladora();
        initComponents();
        //Llamamos a un metodo que llame a la logica y traiga los datos del auto

 ...
 */
package com.mycompany.calculadoraenteros;

/**
 *
 * @author elavincho
 */
public class CalculadoraEnteros extends javax.swing.JFrame {
    int num1;
    int num2;
    String signo;

    /**
     * Creates new form CalculadoraEnteros
     */
    public CalculadoraEnteros() {
        initComponents();
        // Funcion para centrar la app
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculadoraEnteros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculadoraEnteros().setVisible(true);
            }
        });
    }
